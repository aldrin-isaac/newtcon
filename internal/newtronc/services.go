...
//
// The network ID is a required positional parameter on every method — the
// handler layer extracts it from the request path (/api/networks/{netID}/...)
// and passes it through. No context-stashing.
package newtronc
