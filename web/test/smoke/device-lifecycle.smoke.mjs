...
try {
  ...
  if (stateClass === "lifecycle-pill--unrealized") {
    ...
    if (stateClass === "lifecycle-pill--running" || stateClass === "lifecycle-pill--unreachable") {
      expect(actionPlan.hasSshSnippet,
        `${stateClass.replace("lifecycle-pill--", "")} state: SSH snippet present. plan=${JSON.stringify(actionPlan)}`);
    }
  }
